    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ in_array(request()->route()->getName(), ["dashboard.blog.index", "dashboard.posts.create","dashboard.blog.edit", "dashboard.posts.trashed"]) ? "menu-open" : "" }}">
                    <a href="#" class="nav-link {{ in_array(request()->route()->getName(), ["dashboard.blog.index", "dashboard.posts.create", "dashboard.blog.edit", "dashboard.posts.trashed"]) ? "active" : "" }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route("dashboard.blog.index") }}" class="nav-link {{ request()->route()->getName() == "dashboard.blog.index" ? "active" : "" }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Posts</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("dashboard.blog.create") }}" class="nav-link {{ request()->route()->getName() == "dashboard.posts.create" ? "active" : "" }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>New Post</p>
                            </a>
                        </li>
