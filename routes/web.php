...
use App\Http\Controllers\Frontend\AllBlogsController;
...
Route::name("frontend.")->group(function() {
    ...
    Route::get('/blogs', [AllBlogsController::class, 'allBlogs'])->name('blogs');
    Route::get("/blog/{slug}", [PostController::class, "index"])->name("post");
...
Route::name("dashboard.")->prefix("/dashboard")->middleware(["auth"])->group(function() {
    ...
    // posts
    Route::prefix("/blog")->name("posts.")->controller(DashboardPostController::class)->group(function() {
    ...
    Route::resource("/blog", DashboardPostController::class)->except(["show"]);
